...
const Features = () => {
    return (
        <div id='hero' className='flex flex-col items-center justify-between gap-10 xl:px-28 lg:px-20 md:px-10 max-md:px-8 py-16'>
            ...
            <div className='grid lg:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 py-10 gap-14'>
