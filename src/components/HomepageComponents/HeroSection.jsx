...
const HeroSection = () => {
    return (
        <div id='Hero' className='flex flex-row justify-between w-full xl:px-28 lg:px-20 md:px-10 max-md:px-8 py-5 text-white max-lg:flex-col max-lg:items-center max-lg:justify-center max-lg:mt-48'>
